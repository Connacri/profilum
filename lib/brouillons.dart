...
//                             Navigator.pop(ctx);
//                             final provider =
//                             context.read<ProfileCompletionProvider>();
//                             final photo =
//                             await provider.imageService.captureFromCamera();
//                             if (photo != null) {
...
//                             context.read<ProfileCompletionProvider>();
//                             final photo =
//                             await provider.imageService.pickFromGallery();
//                             if (photo != null) {
//                               setState(() => _profilePhoto = photo);
//                             }
//                           },
...
//                         .addGalleryPhotos(fromCamera: true);
//                   },
//                 ),
//                 ListTile(
//                   leading: Container(
...
//                     context
//                         .read<ProfileCompletionProvider>()
//                         .addGalleryPhotos(fromCamera: false);
//                   },
//                 ),
//                 const SizedBox(height: 16),
//               ],
...
//               ),
//               onPressed: () =>
//                   context.read<ProfileCompletionProvider>().removeGalleryPhoto(
//                     index,
//                   ),
//             ),
//           ),
...
//       _showValidationError('Veuillez entrer votre nom');
//       return;
//     }
//
...
//       _showValidationError('Veuillez indiquer qui vous recherchez');
//       return;
//     }
//
//     if (_cityController.text.trim().isEmpty) {
//       _showValidationError('Veuillez entrer votre ville');
//       return;
//     }
//
//     if (_bioController.text.trim().length < 50) {
//       _showValidationError('Votre bio doit contenir au moins 50 caractères');
//       return;
//     }
//
//     if (_selectedInterests.length < 3) {
//       _showValidationError('Sélectionnez au moins 3 centres d\'intérêt');
//       return;
//     }
//
//     setState(() => _isSkipping = true);
